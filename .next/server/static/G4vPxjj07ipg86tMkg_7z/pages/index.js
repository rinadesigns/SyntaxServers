...
// EXTERNAL MODULE: ./components/page.js + 5 modules
...
// CONCATENATED MODULE: ./components/serverTier.js




var serverTier_ServerTier = function ServerTier(props) {
  return external_react_default.a.createElement("div", {
    id: "serverTier",
    className: "jsx-3265438836"
  }, external_react_default.a.createElement("div", {
    id: "icon",
    className: "jsx-3265438836"
  }, external_react_default.a.createElement("img", {
    ...
    id: "cost",
    className: "jsx-3265438836"
  }, "Starting at", external_react_default.a.createElement("br", {
    className: "jsx-3265438836"
  }), external_react_default.a.createElement("div", {
    id: "price",
    className: "jsx-3265438836"
  }, "$", props.price), external_react_default.a.createElement("br", {
    className: "jsx-3265438836"
  }), "/ mo."), external_react_default.a.createElement("div", {
    id: "description",
    className: "jsx-3265438836"
  }, props.desc), external_react_default.a.createElement("div", {
    id: "select",
    className: "jsx-3265438836"
  }, external_react_default.a.createElement(link_default.a, {
    ...
    id: "link",
    className: "jsx-3265438836"
  }, "Learn More"))), external_react_default.a.createElement(style_default.a, {
    id: "3265438836"
  }, ["#serverTier.jsx-3265438836{margin:10px;height:500px;width:250px;background-color:#dbd;}", "#icon.jsx-3265438836{height:100px;background-color:#dad;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;}", "#name.jsx-3265438836{font-family:'Pacifico',cursive;font-size:24pt;background-color:#dbd;color:#555;height:75px;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;}", "#cost.jsx-3265438836{background-color:#dad;font-size:10pt;color:#555;height:75px;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-flex-direction:column;-ms-flex-direction:column;flex-direction:column;-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;}", "#price.jsx-3265438836{margin-top:-16px;margin-bottom:-28px;font-family:'Pacifico',cursive;font-size:24pt;}", "#description.jsx-3265438836{min-height:155px;font-size:11pt;color:#333;padding:10px;text-align:center;}", "#select.jsx-3265438836{height:75px;background-color:#d8d;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;}", "#link.jsx-3265438836{-webkit-text-decoration:none;text-decoration:none;color:#444;background-color:#d7d;width:calc(250px - 20px);height:55px;margin:10px;font-size:18pt;display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;-webkit-align-items:center;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;border-radius:5px;}"]));
};

/* harmony default export */ var serverTier = (serverTier_ServerTier);
...
function Index() {
  return external_react_default.a.createElement("div", {
    ...
    id: "serversDescription",
    className: "jsx-2808024285"
  }, external_react_default.a.createElement("div", {
    id: "serversTitle",
    className: "jsx-2808024285"
  }, "Web Hosting"), "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla finibus ultrices lorem, consectetur interdum nisl aliquam vel. Nulla ut lectus placerat, sodales quam nec, finibus lorem. Praesent ut justo ut odio faucibus egestas ut ac nunc. Vivamus quis tellus ipsum."), external_react_default.a.createElement("br", {
    className: "jsx-2808024285"
  }), external_react_default.a.createElement("div", {
    id: "serversTiers",
    className: "jsx-2808024285"
  }, external_react_default.a.createElement(serverTier, {
    url: "../",
    ...
    id: "serversTitle",
    className: "jsx-2808024285"
  }, "Web Controlled Servers"), "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla finibus ultrices lorem, consectetur interdum nisl aliquam vel. Nulla ut lectus placerat, sodales quam nec, finibus lorem. Praesent ut justo ut odio faucibus egestas ut ac nunc. Vivamus quis tellus ipsum."), external_react_default.a.createElement("br", {
    className: "jsx-2808024285"
  }), external_react_default.a.createElement("div", {
    id: "serversTiers",
    className: "jsx-2808024285"
    ...
    id: "serversTitle",
    className: "jsx-2808024285"
  }, "Dedicated Servers"), "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla finibus ultrices lorem, consectetur interdum nisl aliquam vel. Nulla ut lectus placerat, sodales quam nec, finibus lorem. Praesent ut justo ut odio faucibus egestas ut ac nunc. Vivamus quis tellus ipsum."), external_react_default.a.createElement("br", {
    className: "jsx-2808024285"
  }), external_react_default.a.createElement("div", {
    id: "serversTiers",
    className: "jsx-2808024285"
    ...
    price: "99.90",
    desc: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla finibus ultrices lorem, consectetur interdum nisl aliquam vel. Nulla ut lectus placerat, sodales quam nec, finibus lorem. Praesent ut justo ut odio faucibus egestas ut ac nunc. Vivamus quis tellus ipsum."
  }))), external_react_default.a.createElement(footer["a" /* default */], null)), external_react_default.a.createElement(style_default.a, {
    id: "2808024285"
  }, ["#servers.jsx-2808024285{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;width:calc(70vw - 16px);-webkit-flex-direction:column;-ms-flex-direction:column;flex-direction:column;-webkit-box-pack:center;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;-webkit-align-items:stretch;-webkit-box-align:stretch;-ms-flex-align:stretch;align-items:stretch;}", "#serversTitle.jsx-2808024285{font-size:36pt;text-align:center;margin-bottom:16px;}", "#serversDescription.jsx-2808024285{padding:10px;}", "#serversTitle.jsx-2808024285{font-size:36pt;text-align:center;margin-bottom:16px;}", "#serversDescription.jsx-2808024285{padding:10px;}", "#serversTiers.jsx-2808024285{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;width:calc(70vw - 16px);-webkit-flex-direction:row;-ms-flex-direction:row;flex-direction:row;-webkit-box-pack:center;-webkit-justify-content:center;-ms-flex-pack:center;justify-content:center;-webkit-align-items:stretch;-webkit-box-align:stretch;-ms-flex-align:stretch;align-items:stretch;}", "@media screen and (max-width:1200px){#about.jsx-2808024285{margin-left:-16px;width:calc(70vw - 32px);padding:32px calc(15vw + 16px);}#servers.jsx-2808024285{width:calc(100vw - 16px * 2);}#serversTiers.jsx-2808024285{width:calc(572px - 16px * 2);padding:0 calc(50vw - 572px / 2);-webkit-flex-wrap:wrap;-ms-flex-wrap:wrap;flex-wrap:wrap;}}", "@media screen and (max-width:calc(572px - 16px * 2)){#serversTiers.jsx-2808024285{width:100vw;}}"]));
}
