...
function About() {
  return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
    ...
    id: "aboutDescription",
    className: "jsx-179662688"
  }, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla finibus ultrices lorem, consectetur interdum nisl aliquam vel. Nulla ut lectus placerat, sodales quam nec, finibus lorem. Praesent ut justo ut odio faucibus egestas ut ac nunc. Vivamus quis tellus ipsum.", react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("br", {
    className: "jsx-179662688"
    ...
    id: "179662688"
  }, ["#about.jsx-179662688{display:-webkit-box;display:-webkit-flex;display:-ms-flexbox;display:flex;background-image:url('./static/topbg.png');background-size:cover;overflow-x:hidden;width:calc(70vw - 16px);padding:0 calc(15vw + 8px);height:calc(100vh - 64px);margin-left:calc(-15vw - 8px);margin-top:-32px;-webkit-flex-direction:column;-ms-flex-direction:column;flex-direction:column;-webkit-box-pack:space-evenly;-webkit-justify-content:space-evenly;-ms-flex-pack:space-evenly;justify-content:space-evenly;-webkit-align-items:stretch;-webkit-box-align:stretch;-ms-flex-align:stretch;align-items:stretch;}", "#aboutTitle.jsx-179662688{font-size:36pt;text-align:center;margin-bottom:16px;margin-top:-64px;}", "#aboutDescription.jsx-179662688{padding:10px;}", "@media screen and (max-width:1200px){#about.jsx-179662688{margin-left:-16px;width:calc(70vw - 32px);padding:32px calc(15vw + 16px);}}"]));
}
